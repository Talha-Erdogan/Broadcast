...
using Broadcast.Web.Models.Announcement;
...
namespace Broadcast.Web.Controllers
{
    public class AnnouncementController : Controller
    {
        ...
        [AppAuthorizeFilter(AuthCodeStatic.PAGE_ANNOUNCEMENT_LIST)]
        ...
        [AppAuthorizeFilter(AuthCodeStatic.PAGE_ANNOUNCEMENT_EDIT)]
        ...
        [AppAuthorizeFilter(AuthCodeStatic.PAGE_ANNOUNCEMENT_EDIT)]
        [HttpPost]
        public ActionResult Edit(Models.Announcement.AddViewModel model, IFormFile ImageFilePath)
        {
            //image ekleme için faydalanılan link -> https://www.webtrainingroom.com/aspnetcore/file-upload
            model.ImageFilePath = ImageFilePath;
            if (ImageFilePath != null)
        ...
        [AppAuthorizeFilter(new string[] { AuthCodeStatic.PAGE_ANNOUNCEMENT_ACTIVEPASSIVE })]
        public ActionResult MakeActive(int id)
        {
            ...
            if (apiUpdateStatusResponseModel.ResultStatusCode != ResultStatusCodeStatic.Success)
            {
                ...
                return RedirectToAction(nameof(AnnouncementController.List), "Announcement", new { errorMessage = errorMessage });
            }
            else
            {
                return RedirectToAction(nameof(AnnouncementController.List), "Announcement");
        ...
        [AppAuthorizeFilter(AuthCodeStatic.PAGE_ANNOUNCEMENT_DISPLAY)]
